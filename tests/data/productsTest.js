...
describe('test suite: Clothing class', () => {
  ...
  it('works without an error', () => {
    ...
    expect(clothing1.getStarsUrl()).toEqual(`images/ratings/rating-45.png`)
    ...
    expect(clothing1.extraInfoHTML()).toContain('Size chart');
  })
})
...
describe('test suite: Appliance class', () => {
  ...
  it('works without an error', () => {
    ...
    expect(appliance1.getStarsUrl()).toEqual(`images/ratings/rating-50.png`)
    expect(appliance1.getPrice()).toEqual('$18.99')
    expect(appliance1.extraInfoHTML()).toContain(`<a href="${appliance1.instructionsLink}" target="_blank">
        Instructions
      </a>
